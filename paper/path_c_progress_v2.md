...
| -------- | ------- | -------------- | ----------------- | -------------- | ----- | --- |
| 25% | 5 | 6.92 ± 0.42 | 7.16 ± 0.42 | -0.25 | t=-1.26 (p=0.276) | -0.56 |
| 50% | 5 | 8.50 ± 0.71 | 9.22 ± 0.43 | -0.72 | t=-2.20 (p=0.093) | -0.98 |
...
| ---- | -------- | ---------------- | ------------ | ------- | ------- | --- |
| **MIC + CRNN** | 5 | 45.38 ± 6.38 | 46.26 ± 7.50 | **-0.88** | t=-0.15 (p=0.887) | **-0.07** |
| **FOA + CRNN** | 3 | 39.79 ± 2.47 | 47.51 ± 6.90 | **-7.72** | t=-3.00 (p=0.095) | **-1.73** |
| **MIC + Xfm** | 3 | 50.17 ± 1.69 | 42.02 ± 1.74 | **+8.15** | t=+4.13 (p=0.054) | **+2.38** |
| **FOA + Xfm** | 3 | 40.42 ± 3.31 | 37.86 ± 3.94 | **+2.55** | t=+0.61 (p=0.602) | **+0.35** |
