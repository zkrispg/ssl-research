...
\begin{tikzpicture}[font=\sffamily]
  ...
  \node[align=center,font=\sffamily\bfseries] at (6,3.55)
    {Array-geometry priors help SELD \emph{only} when the temporal backbone lacks locality};
  ...
  % --- Conformer: neutral (small, gray) ---
  \fill[cNeut] (5.3,0) rectangle (6.7,-0.28);
  \node[cNeut,anchor=south,font=\sffamily\small\bfseries] at (6.0,0.40) {neutral $\approx 0$};
