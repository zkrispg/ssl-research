...
except ImportError:  # pragma: no cover - audio-only path doesn't need it
...
# Lazy imports for video / image deps -- only required when modality == 'audio_visual'.
try:
    from cls_vid_features import VideoFeatures  # type: ignore  # noqa: F401
    from PIL import Image  # type: ignore  # noqa: F401
    import cv2  # type: ignore  # noqa: F401
    _HAS_VIDEO_DEPS = True
except ImportError:  # pragma: no cover
    VideoFeatures = None  # type: ignore
